...
"use strict";$(document).ready(function(){var e=$("#shopSlider");e.owlCarousel({items:3,loop:!0,dots:!1,smartSpeed:500,margin:2}),$("#shopSliderRight").click(function(){e.trigger("next.owl.carousel")}),$("#shopSliderLeft").click(function(){e.trigger("prev.owl.carousel")})});
