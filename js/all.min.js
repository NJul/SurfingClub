...
"use strict";function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}$(document).ready(function(){var e=$("#headerSlider");function t(e){if(e.namespace){var t=e.relatedTarget;$(".slider-my-controls-number__active").text(t.relative(t.current())+1)}}e.owlCarousel(_defineProperty({items:1,loop:!0,dots:!1,smartSpeed:1e3,autoplay:!0,autoplayHoverPause:!0,onInitialized:t,onChanged:t},"onInitialized",function(e){$(".slider-my-controls-number__active").text(1),$(".slider-my-controls-number__total").text(this.items().length)})),$("#headerSliderRight").click(function(){e.trigger("next.owl.carousel")}),$("#headerSliderLeft").click(function(){e.trigger("prev.owl.carousel")})});
"use strict";$(document).ready(function(){var e=$("#shopSlider");e.owlCarousel({loop:!0,dots:!1,smartSpeed:500,margin:2,responsive:{0:{items:1},1254:{items:3}}}),$("#shopSliderRight").click(function(){e.trigger("next.owl.carousel")}),$("#shopSliderLeft").click(function(){e.trigger("prev.owl.carousel")})});
