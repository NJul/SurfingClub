...
"use strict";$(document).ready(function(){var e=$(".owl-carousel");e.owlCarousel({items:1,loop:!0,dots:!1,smartSpeed:1e3}),$("#headerSliderRight").click(function(){e.trigger("next.owl.carousel")}),$("#headerSliderLeft").click(function(){e.trigger("prev.owl.carousel")})});
