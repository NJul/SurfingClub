...
"use strict";$(document).ready(function(){var e=$("#headerSlider");e.on("initialized.owl.carousel",function(e){$(".slider-my-controls-number__active").text(e.item.index+1),$(".slider-my-controls-number__total").text(e.item.count)}),e.owlCarousel({items:1,dots:!1,smartSpeed:1e3}),$("#headerSliderRight").click(function(){e.trigger("next.owl.carousel")}),$("#headerSliderLeft").click(function(){e.trigger("prev.owl.carousel")}),e.on("changed.owl.carousel",function(e){$(".slider-my-controls-number__active").text(e.item.index+1),$(".slider-my-controls-number__total").text(e.item.count)})});
